...
def get_data_migration_world_bank(list_get_indicators):
    ...
    # Crear un dataframe vacío con dos columnas: código y nombre
    df_countries = pd.DataFrame(columns=['cod_country', 'country'])

    # Iterar a través de la lista de países y agregar una nueva fila al dataframe para cada país
...
################################ iniciando con la transformación de los datos ###########################
