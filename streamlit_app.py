...
datos_a_excluir = ['Africa Eastern', 'Africa Western', 'World', 'Early', 'Europe & Central Asia', 'Fragile','Heavily', 'High', 'IBDR', 'IDA', 'Latin', 'Low', 'Middle', 'North America', 'OECD', 'Other small', 'Post-', 'Pre-', 'Upper', ]
