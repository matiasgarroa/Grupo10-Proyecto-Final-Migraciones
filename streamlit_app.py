...
datos_a_excluir = ['Africa Eastern', 'Africa Western', 'World', 'Early', 'Europe & Central Asia', 'Heavily', 'High income' 'IBDR', 'IDA', 'Latin', 'Low', 'Middle', 'North America', 'OECD', 'Other small', 'Post-', 'Pre-', 'Upper', ]
